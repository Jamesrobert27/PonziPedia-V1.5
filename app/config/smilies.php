...
|--------------------------------------------------------------------------
|
| The images are stored in assets/img/smiles/.
| By default the script does not have the actual images included.
| You can use your own images or buy these: 
| http://graphicriver.net/item/matte-motes-emoticon-set/33923
|
*/
return array(
	/*

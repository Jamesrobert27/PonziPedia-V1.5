...
if (isset($_POST['confirmTestimony'])) {
 $id  = $_POST['test_id'];
 ...
 if ($sql) {
 	 echo'<div class="alert alert-success" role="alert">
      You have successfully approved user testimony and now apear live on website to other members and visitors.
      </div>';
 }
}
?>
